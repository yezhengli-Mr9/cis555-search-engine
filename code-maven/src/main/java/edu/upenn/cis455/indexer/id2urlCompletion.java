...
//        }
    ...
    private static void insertQuery(String id2urlquery, Connection conn, int cntUrl, int cntSqlVal_ud2url, int basecntUrl){
//        try {
//
...
//            id2urlquery += " ON DUPLICATE KEY UPDATE id=VALUES(id)";
            id2urlquery += " ON DUPLICATE KEY UPDATE rawUrl=VALUES(rawUrl)";
//            System.out.print(id2urlquery);
...
//                + " VALUES";
        String id2urlquery = " INSERT INTO id2url (id, rawUrl) VALUES";
...
//            System.out.println(cntSqlVal+url);
            ...
            if (1 <=(cntSqlVal>>byte_len)) {//yezheng: large batch process
                cntSqlVal = 0;
                insertQuery(id2urlquery, conn, cntUrl , cntSqlVal_ud2url, basecntUrl);

                id2urlquery = " INSERT INTO id2url (id, rawUrl) VALUES";
