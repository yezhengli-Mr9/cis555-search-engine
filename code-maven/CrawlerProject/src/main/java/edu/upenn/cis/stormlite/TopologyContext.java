...
public class TopologyContext {
	...
	public AtomicInteger numWritten = new AtomicInteger(0);
	public AtomicInteger queueLength = new AtomicInteger(0);
	...
	public TopologyContext(Topology topo, Queue<Runnable> theTaskQueue, String name) {
		topology = topo;
		taskQueue = theTaskQueue;
		this.jobName = name;
	}
